                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label>เลขประจำตัวคนต่างด้าว</label>
                                                <input class="form-control" type="text" name="f23"> 
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>ไม่สามารถดำเนินการเกี่ยวกับการขอใบอนุญาตทำงาน/การขอรับใบอนุญาตทำงาน/การขอเปลี่ยนการทำงาน</label>
                                                <label for="">หรือเปลี่ยนท้องที่หรือสถานที่ในการทำงาน/การขอรับใบแทนใบอนุญาตทำงานด้วยตัวเองได้เนื่องจาก</label>
                                                <input class="form-control" type="text" name="f25">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>จึงมอบอำนาจให้</label>
                                                <input class="form-control" type="text" name="f25"> 
                                            </div>
