...
<div style="page-break-after: always;">
    ...
    <!-- <p style="position:fixed;color:red;margin:550px 110px">สัญชาติ</p>
    <p style="position:fixed;color:red;margin:550px 240px">สัญชาติ</p>
    <p style="position:fixed;color:red;margin:550px 410px">ชื่อ</p> -->
    ...
    <p style="position:fixed;color:red;margin:640px 140px">ทาง</p>
    <p style="position:fixed;color:red;margin:640px 410px">วัน</p>
    <p style="position:fixed;color:red;margin:640px 520px">เดือน</p>
    <p style="position:fixed;color:red;margin:640px 640px">ปี</p>
    <p style="position:fixed;color:red;margin:660px 300px">ปี</p>
    <p style="position:fixed;color:red;margin:685px 300px">ปี</p>
...
<div style="page-break-after: unset;">
    ...
    <p style="position:fixed;color:red;margin:75px 190px">ที่พัก</p>
    <p style="position:fixed;color:red;margin:100px 260px">ข้าพเจ้า</p>
    <p style="position:fixed;color:red;margin:130px 280px">ข้าพเจ้า</p>
    ...
    <p style="position:fixed;color:red;margin:180px 140px">เลขที่</p>
    <p style="position:fixed;color:red;margin:180px 310px">ถนน</p>
    <p style="position:fixed;color:red;margin:180px 600px">ตำบล</p>
    <p style="position:fixed;color:red;margin:200px 140px">อำเภอ</p>
    <p style="position:fixed;color:red;margin:200px 420px">จังหวัด</p>
    <p style="position:fixed;color:red;margin:230px 200px">อำเภอ</p>
    <p style="position:fixed;color:red;margin:230px 580px">จังหวัด</p> -->
