...
$(function () {
    oTable = $('#data-table').DataTable({
        ...
        rowCallback: function (nRow, aData, dataIndex) {
            ...
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" target="_blank" href="form/bd1/'+aData["title_id"]+'"class="btn btn-sm btn-success">หนังสือแสดงความต้องการ</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" target="_blank" href="form/bd2/'+aData["title_id"]+'"class="btn btn-sm btn-success">บัญชีรายชื่อแรงงานต่างด้าว</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" target="_blank" href="form/bd3/'+aData["title_id"]+'"class="btn btn-sm btn-success">บต.29</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="form/bd4/'+aData["title_id"]+'"class="btn btn-sm btn-success">บต.46</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="form/bd5/'+aData["title_id"]+'"class="btn btn-sm btn-success">สัญญาจ้าง</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="form/bd6/'+aData["title_id"]+'"class="btn btn-sm btn-success">หนังสือมอบอำนาจ(1)</a></div>'
            +'<div class="collapse" id="collapseExample'+dataIndex+'"><a style="width:70%;margin:5px 0px" href="form/bd7/'+aData["title_id"]+'"class="btn btn-sm btn-success">หนังสือมอบอำนาจ(2)</a></div>'
            ).addClass('input');
