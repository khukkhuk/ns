...
<body style="top:0;left:0">
 <div style="page-break-after: always;">
    ...
    <p style="position:fixed;margin:660px 220px">{{$pdf->f25}}</p>
    <p style="position:fixed;margin:627px 120px">{{$pdf->f12}}</p>

    <p style="position:fixed;margin:755px 245px">{{$pdf->f13}}</p>
    ...
    <p style="position:fixed;margin:815px 125px">{{$pdf->f14}} ต.{{$p17->name_th}} อ.{{$p16->name_th}} จ.{{$p15->name_th}}</p>
    

</div>
 <div style="page-break-after: always;">
    <img src="backend/images/pinkcard/3 ภาษา กัมพูชา_page-0002.jpg" style="margin:-45px;position:fixed;width:800px" alt="">
    <p style="position:fixed;margin:50px 230px">{{$pdf->f18}}</p>
    <p style="position:fixed;margin:80px 220px">{{$pdf->f19}}</p>
    <p style="position:fixed;margin:210px 230px">{{$pdf->f20}}</p>
    <p style="position:fixed;margin:275px 250px">{{$pdf->f21}}</p>
    <p style="position:fixed;margin:370px 90px">{{$pdf->f22}}</p>
    <p style="position:fixed;margin:525px 85px">{{$pdf->f23}}</p>
    <p style="position:fixed;margin:620px 30px">{{$pdf->f24}}</p>
</div>
