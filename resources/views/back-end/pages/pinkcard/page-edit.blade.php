                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input class="form-control"nSame="alley_th" value="{{$rowr->alley_th}}" id="alley_th" type="text">
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input class="form-control"nSame="alley_en" value="{{$rowr->alley_en}}" id="alley_en" type="text">
                                                        </select>
                                                    </div>
