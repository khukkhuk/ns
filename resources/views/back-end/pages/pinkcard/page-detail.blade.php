<div class="fadeOut">
    ...
    <?php
        ...
        $ep_en = (\app\Models\Backend\Provinces::find($rowe->workplace_province_id))->name_en;
        $ed_en = (\app\Models\Backend\District::find($rowe->workplace_district_id))->name_en;
        $esd_en = (\app\Models\Backend\SubDistrict::find($rowe->workplace_subdistrict_id))->name_en;
    ?>
    <div class="row">
        <div class="col-sm-9">
            <div class="card">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label>จังหวัด(TH)</label>
                                                            <select name="province" id="province_edit" class="form-control" value="">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input class="form-control" name="zipcode" id="zipcode" value="{{$rowr->zipcode}}"  type="text">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <select name="workplace_province_id_edit" id="workplace_province_id_edit" class="form-control">
                                                                ...
                                                                @foreach($province as $row)
                                                                    <option value="{{$row->id}}" @if($row->id == $rowe->workplace_province_id) selected @endif>{{$row->name_th}}</option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-2">
                                                        ...
                                                        @foreach($district as $row)
                                                                    <option value="{{$row->id}}" @if($row->id == $rowe->workplace_district_id) selected @endif>{{$row->name_th}}</option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        @foreach($subdistrict as $row)
                                                                    <option value="{{$row->id}}" @if($row->id == $rowe->workplace_subdistrict_id) selected @endif>{{$row->name_th}}</option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="">รหัสไปรษณีย์(EN)</label>
                                                        <input class="form-control"  type="number" value="{{$rowe->workplace_zipcode}}" id="w_zipcode_en" name="zipcode_en">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    // console.log(document.getElementById("p_th"));
    // console.log($("#select_p_th").val())
    // $("#province_edit").append($("#select_p_th").val());
